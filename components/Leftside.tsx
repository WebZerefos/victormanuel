...
function Leftside() {
	return (
		<div className='w-full h-full flex flex-col items-center justify-end gap-6 text-white'>
			<div className='flex flex-col gap-6'>
				<a
					href='https://github.com/WebZerefos'
					className='hover:scale-125 transition duration-300'
				>
					<span className='w-10 h-10 text-xl bg-slate-500 rounded-full inline-flex items-center justify-center'>
						<RiGithubLine />
					</span>
				</a>
				<a
